...
public class Register1 {
    Register1(){
     Font f=new Font("Serif",Font.BOLD,40);
        ...
        String country[]= {"--SELECT AN OPT--","JAMMU & KASHMIR","HIMACHAL PRADESH","PUNJAB","HARYANA","DELHI","RAJASTAN","GUJARAT","UTTARAKHAND","UTTARPRADESH","BIHAR","JHARKHAND","SIKKIM","WEST BENGAL","MEGHALAYA","TRIPURA","MIZORAM","MANIPUR","NAGALAND","ARUNACHAL PRADESH","ASSAM","MADHYAPRADESH","CHATTISGARH","ODISHA","MAHARASTRA","ANDHRAPRADESH","GOA" ,"KARNATAKA","TAMILNADU","KERALA","TELANGANA"};    
